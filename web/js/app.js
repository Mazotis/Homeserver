    ...
    function getResult() {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                cnt = 0
                var html = '<div class="row"><div id="update-spin" class="col-12"><center><h5><div class="spinner-border" role="status"></div>&nbsp;Updating device status...</h5></center></div><div class="col-sm-4">'
    ...
    function computeCards() {
        ...
        $(".gcard").each(function() {
            var group, cid
            group = $(this).find("div.card-header").text()
            cid = $(this).attr("id")
